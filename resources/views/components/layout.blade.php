...
<body style="font-family: Open Sans, sans-serif">
    <section class="px-6 py-8">
        ...
        <footer id="newsletter" class="bg-gray-100 border-black hoverborder-opacity-5  rounded-xl text-center mt-16 py-16 px-10">
            ...
            <div class="mt-10">
                <div class="relative inline-block mx-auto lg-gray-200 rounded-full">
                    ...
                    <form action="#" method="POST" class="lg:flex item-center text-sm bg-gray-200 rounded-full">
